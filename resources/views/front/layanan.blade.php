                ...
                <div class="col-xl-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $lapub->judul }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    <div class="post-details-content bg-white p-30 mb-30 mt-30 bx-shadow">
                        <div class="mb-30">
                            <img src="{{ url('storage/layanan', $lapub->gambar) }}" class="img-details">
                        </div>
                        <div class="blog-content">
                            <h4 class="post-title">{{ $lapub->judul }}</h4>
                            <div class="post-meta-2">
                                <a href="#"><i class="bi bi-calendar"></i>
                                    {{ date('d M Y', strtotime($lapub->tanggal)) }}</a>
                                <a href="#"><i class="bi bi-clock"></i> {{ $lapub->jam }} WIB</a>
                            </div>
